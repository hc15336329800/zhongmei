...
public class SysPostService : BaseService<SysPost, SysPostDto>, ITransient
{
    ...
    public SysPostService(ILogger<SysPostService> logger, SysPostRepository sysPostRepository, SysUserPostRepository sysUserPostRepository)
    {
