...
namespace RuoYi.System.Repositories
{
    public class SysUserRoleRepository : BaseRepository<SysUserRole, SysUserRoleDto>
    {
        ...
        {
            return Repo.AsQueryable().WhereIF(dto.UserId > 0, (t) => t.UserId == dto.UserId).WhereIF(dto.RoleId > 0, (t) => t.RoleId == dto.RoleId);
        }

        public override ISugarQueryable<SysUserRoleDto> DtoQueryable(SysUserRoleDto dto)
        {
            return Repo.AsQueryable().WhereIF(dto.UserId > 0, (t) => t.UserId == dto.UserId).WhereIF(dto.RoleId > 0, (t) => t.RoleId == dto.RoleId).Select((t) => new SysUserRoleDto { UserId = t.UserId, RoleId = t.RoleId });
        }
