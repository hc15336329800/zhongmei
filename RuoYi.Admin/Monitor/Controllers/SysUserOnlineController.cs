...
namespace RuoYi.System.Controllers
{
    ...
    public class SysUserOnlineController : ControllerBase
    {
        ...
        public SysUserOnlineController(ILogger<SysOperLogController> logger, ICache cache, SysUserOnlineService sysUserOnlineService)
        {
            _logger = logger;
            _cache = cache;
        ...
        {
            var keys = _cache.GetDbKeys(CacheConstants.LOGIN_TOKEN_KEY + "*", 10000);
